...
<head>
    <title>MyApp</title>
      ...
      <!-- ico font -->
      <link rel="stylesheet" type="text/css" href="dashboard/assets/icon/icofont/css/icofont.css">
      <!-- Style.css -->
                       ...
                       <ul class="nav-right">
                           <li class="header-notification">
                               ...
                               <ul class="show-notification">
                                   ...
                                   <li>
                                       <div class="media">
                                           <img class="d-flex align-self-center img-radius" src="dashboard/assets/images/avatar-2.jpg" alt="Generic placeholder image">
                                   ...
                                   <li>
                                       <div class="media">
                                           <img class="d-flex align-self-center img-radius" src="dashboard/assets/images/avatar-4.jpg" alt="Generic placeholder image">
                                           <div class="media-body">
                                   ...
                                   <li>
                                       <div class="media">
                                           <img class="d-flex align-self-center img-radius" src="dashboard/assets/images/avatar-3.jpg" alt="Generic placeholder image">
                                           <div class="media-body">
                           ...
                           <li class="user-profile header-notification">
                               <a href="#!">
                                   <img src="dashboard/assets/images/avatar-4.jpg" class="img-radius" alt="User-Profile-Image">
                                   <span>John Doe</span>
...
<!-- modernizr js -->
<script type="text/javascript" src="dashboard/assets/js/modernizr/modernizr.js"></script>
<!-- am chart -->
<script src="dashboard/assets/pages/widget/amchart/amcharts.min.js"></script>
<script src="dashboard/assets/pages/widget/amchart/serial.min.js"></script>
<!-- Chart js -->
<script type="text/javascript" src="dashboard/assets/js/chart.js/Chart.js"></script>
<!-- Todo js -->
<script type="text/javascript " src="dashboard/assets/pages/todo/todo.js "></script>
<!-- Custom js -->
<script type="text/javascript" src="dashboard/assets/pages/dashboard/custom-dashboard.min.js"></script>
<script type="text/javascript" src="dashboard/assets/js/script.js"></script>
<script type="text/javascript " src="dashboard/assets/js/SmoothScroll.js"></script>
<script src="dashboard/assets/js/pcoded.min.js"></script>
<script src="dashboard/assets/js/vartical-demo.js"></script>
